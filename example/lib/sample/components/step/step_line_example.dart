            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return BrnStepLine(
                  ...
                  lineColor: index == 2 ? Colors.transparent : Color(0xffeeeeee),
...
ListView.builder(
  ...
  dynamic getLineColor(int index) {
    return index == 1
        ? [BrnThemeConfigurator.instance.getConfig().commonConfig.brandPrimary, Colors.red]
        : (index == 2 ? Colors.transparent : Color(0xffeeeeee));
  }
