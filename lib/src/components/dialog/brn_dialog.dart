...
class BrnDialog extends AlertDialog {
  ...
  BrnDialogConfig? _convertStyleToConfig() {
    ...
    defaultConfig = defaultConfig.merge(BrnDialogConfig(
      ...
      iconPadding: brnDialogStyle!.iconPadding as EdgeInsets?,
      titlePaddingSm: brnDialogStyle!.titlePadding as EdgeInsets?,
      titlePaddingLg: brnDialogStyle!.titlePadding as EdgeInsets?,
      titleTextAlign: brnDialogStyle!.titleTextAlign,
      titleTextStyle: BrnTextStyle.withStyle(brnDialogStyle!.titleTextStyle),
      contentPaddingSm: brnDialogStyle!.contentPadding as EdgeInsets?,
      contentPaddingLg: brnDialogStyle!.contentPadding as EdgeInsets?,
      contentTextAlign: brnDialogStyle!.contentTextAlign,
      contentTextStyle:
          BrnTextStyle.withStyle(brnDialogStyle!.contentTextStyle),
      warningPaddingSm: brnDialogStyle!.warningPadding as EdgeInsets?,
      warningPaddingLg: brnDialogStyle!.warningPadding as EdgeInsets?,
